...
* Multiple protocol support: both HTTP and SOCKS5 are supported
  * [TrustTunnel](https://trusttunnel.org/) extensions for UDP and healthchecks are supported as well, dumbproxy server running with HTTPS enabled is compatible with TrustTunnel client.
